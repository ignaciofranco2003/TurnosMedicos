        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreEspecialidad = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefono = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Matricula = table.Column<string>(type: "varchar(25)", maxLength: 25, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DuracionTurnoMin = table.Column<int>(type: "int", nullable: false),
                    RowVersion = table.Column<DateTime>(type: "timestamp(6)", rowVersion: true, nullable: true)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.ComputedColumn)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DisponibilidadMedico", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DisponibilidadMedico_Medicos_MedicoId",
                        column: x => x.MedicoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefono = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TieneObraSocial = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DisponibilidadMedico_MedicoId_DiaSemana_HoraDesde_HoraHasta",
                table: "DisponibilidadMedico",
                columns: new[] { "MedicoId", "DiaSemana", "HoraDesde", "HoraHasta" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Turnos_IdMedico_Inicio_Fin",
                table: "Turnos",
                columns: new[] { "IdMedico", "Inicio", "Fin" });
